...
const requireUser = (req, res, next) => {
  ...
  // Admins have req.user.admin_level — regular users do not
...
module.exports = { requireAdmin, requireRole, requireSelfOrRole, requireUser };

// ─────────────────────────────────────────────────────────────────────────────
// REQUIRE USER
// Ensures the request is from an authenticated regular user (not an admin).
// Used for user-only endpoints like payments from the mobile app.
// ─────────────────────────────────────────────────────────────────────────────