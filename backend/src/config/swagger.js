      ...
      schemas: {
        ...
        TicketResponse: {
          ...
          properties: {
            ...
            charged_as:              { type: 'string', enum: ['OWNER', 'RENTER'] },
            enforcement_id:          { type: 'string', format: 'uuid', nullable: true },
            status:                  { type: 'string', enum: ['UNPAID', 'PAID', 'DISPUTED', 'CANCELLED'] },
            amount:                  { type: 'number', example: 15.00, nullable: true },
            created_at:              { type: 'string', format: 'date-time' },
            plate_number:            { type: 'string', example: 'ABC 1234' },
            make:                    { type: 'string', example: 'Toyota', nullable: true },
            model:                   { type: 'string', example: 'Corolla', nullable: true },
            ...
            rate_per_hour:           { type: 'number', example: 5.00, nullable: true },
            max_daily_cap:           { type: 'number', example: 40.00, nullable: true },
            zone_name:               { type: 'string', example: 'Main Entrance Zone', nullable: true },
          },
        },
        UpdateTicketBody: {
          type: 'object',
          description: 'Admin manual override. At least one field required.',
          properties: {
            status: { type: 'string', enum: ['UNPAID', 'PAID', 'DISPUTED', 'CANCELLED'] },
